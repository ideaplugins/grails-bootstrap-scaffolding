...
<div class="row">
    <div class="span8">
        ...
        <g:form action="save" id="editForm" class="form-horizontal"
                accept-charset="UTF-8" <%=multiPart ? ' enctype="multipart/form-data"' : '' %>>
        ...
        <fieldset>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary"><i class="icon-ok"></i> <g:message
